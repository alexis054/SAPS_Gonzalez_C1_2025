...
filtro_fir = np.load('C:/Repositorio/SAPS_Gonzalez_C1_2025/dataset_figuras/FILTROS/IIR/cheby6.npz', allow_pickle=True)
filtro_iir = np.load('C:/Repositorio/SAPS_Gonzalez_C1_2025/dataset_figuras/FILTROS/IIR/cheby6.npz', allow_pickle=True) 

# Se muestran parámetros de diseño
print("Filtro FIR:")
filter_parameters.filter_parameters('C:/Repositorio/SAPS_Gonzalez_C1_2025/dataset_figuras/FILTROS/IIR/cheby6.npz')
print("\r\n")
print("Filtro IIR:")
filter_parameters.filter_parameters('C:/Repositorio/SAPS_Gonzalez_C1_2025/dataset_figuras/FILTROS/IIR/cheby6.npz')
print("\r\n")
