...
valor_fm_2_1 = np.max( fft_senial_1 [np.where(frec_1 == fs2_1) ] )
...
valor_fm_2_2 = np.max( fft_senial_2 [np.where(frec_2 == fs2_2) ] )
...
valor_fm_2_3 = np.max( fft_senial_3 [np.where(frec_3 == fs2_3) ] )
frec_fm_2_3 = frec_1[np.argmax(fft_senial_1[np.where(frec_1 ==fs2_3) ] ) ] + fs2_3


print("En la senial 1")
print(f"Máximo valor: {amp_max_1} a {frecuencia_max_1} Hz")
print(f"Valor en fs/2: {valor_fm_2_1} a {frec_fm_2_1} Hz \n")

print("En la senial 2")
print(f"Máximo valor: {amp_max_2} a {frecuencia_max_2} Hz")
print(f"Valor en fs/2: {valor_fm_2_2} a {frec_fm_2_2} Hz \n")

print("En la senial 3")
print(f"Máximo valor: {amp_max_3} a {frecuencia_max_3} Hz")
print(f"Valor en fs/2: {valor_fm_2_3} a {frec_fm_2_3} Hz \n")

frec_max = 0

#Busco el maximo de las fs/2
max_fs2 = 0
if(max_fs2 < valor_fm_2_1):
    max_fs2 = valor_fm_2_1

if(max_fs2 < valor_fm_2_2):
    max_fs2 = valor_fm_2_2

if(max_fs2 < valor_fm_2_3):
    max_fs2 = valor_fm_2_3
...
at_fs2_1 = 20*np.log10(valor_fm_2_1/RES)
at_fs2_2 = 20*np.log10(valor_fm_2_2/RES)
at_fs2_3 = 20*np.log10(valor_fm_2_3/RES)
...
print(f"Atenuación max en fs/2 a {at_max:.2f}dB en {frecuencia_max_1}Hz \n") # porque en todas las seniales la condicion se da en la misma frecuencia 
...
ax3.plot(frecuencia_max_1, -at_max, marker='X', markersize=12, label='Requisito en máximo')
